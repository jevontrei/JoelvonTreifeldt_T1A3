...
def main():
    ...
    while True:
        ...
        if selection == 1:
            ...
            # Angus: think about handling this input in case of integer inut, for e.g.
            melody_input = input(
            ...
            # if type(melody_input) != str:
            #     print
            #     raise TypeError("Only text strings are valid.")
            ...
            if len(melody_input) < 2:
                print()
                print(
                    ">>> Pssst! The result will be more meaningful if you enter more than one note! :')")
            ...
            # how to catch error from module?
            ...
            # Angus: not every function necessarily needs to have a try block. !Am i doubling up try/except blocks? it's here AND also in the module :S ... HOWEVER for some reason if i delete the main try/except block and just use the inner/module one, when it fails it doesn't go back to prompting user for input. why?
            # try:
